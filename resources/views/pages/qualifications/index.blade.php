...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                <div>
                    <h4 class="mb-1">Qualifications<span class="badge badge-soft-primary ms-2">{{ $qualifications->total() }}</span></h4>
                ...
                <div class="gap-2 d-flex align-items-center flex-wrap">
                    <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#add_Qualification">
                        <i class="ti ti-square-rounded-plus-filled me-1"></i>Add New Qualifications
                    </a>
                </div>
            </div>
            <!-- End Page Header -->
            ...
            <div class="card border-0 rounded-0">
                ...
                <div class="card-body">
                    <div class="table-responsive custom-table">
                        <table class="table table-nowrap datatable" id="QualificationsTable">
                            ...
                            <tbody>
                                @foreach ($qualifications as $qualification)
                                            ...
                                            <div class="dropdown table-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item edit-btn" href="#" data-bs-toggle="modal"
                                                        data-bs-target="#edit_Qualification{{ $qualification->id }}">
                                                        <i class="ti ti-edit text-blue"></i> Edit
                                                    </a>
                                                    <a class="dropdown-item delete-btn" href="#"
                                                        data-bs-toggle="modal" data-bs-target="#delete_Qualification{{ $qualification->id }}"
                                                        >
                                    ...
                                    <div class="modal fade" id="edit_Qualification{{ $qualification->id }}" role="dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('qualifications.update', $qualification->id) }}" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            <label class="form-label">Qualification Name <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" name="name"
                                                                value="{{ $qualification->name }}" class="form-control" required>
                                                        </div>
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2">
                                                                    <input type="radio" class="status-radio"
                                                                        id="edit-active-{{ $qualification->id }}"
                                                                        name="status" value="1"
                                                                        {{ $qualification->status == 1 ? 'checked' : '' }}>
                                                                    <label
                                                                        for="edit-active-{{ $qualification->id }}">Active</label>
                                                                </div>
                                                                <div>
                                                                    <input type="radio" class="status-radio"
                                                                        id="edit-inactive-{{ $qualification->id }}"
                                                                        name="status" value="0"
                                                                        {{ $qualification->status == 0 ? 'checked' : '' }}>
                                                                    <label
                                                                        for="edit-inactive-{{ $qualification->id }}">Inactive</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="delete_Qualification{{ $qualification->id }}" role="dialog">
    ...
    <div class="modal fade" id="add_Qualification" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
