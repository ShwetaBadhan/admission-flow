...
@section('content')
    <div class="page-wrapper">
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                <div>
                    <h4 class="mb-1">Documents<span class="badge badge-soft-primary ms-2">{{ $documentsettings->total() }}</span>
                    </h4>
            ...
            <div class="card border-0 rounded-0">
                ...
                <div class="card-body">
                    <div class="table-responsive custom-table">
                        <table class="table table-nowrap datatable" id="DocumentsTable">
                            ...
                            <tbody>
                                @foreach ($documentsettings as $setting)
                                    ...
                                    <!-- Edit Document Modal -->
                                    <div class="modal fade" id="edit_Document{{ $setting->id }}" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('document-settings.update', $setting->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            <label class="form-label">Document Name <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" name="name"
                                                                value="{{ $setting->name }}" class="form-control" required>
                                                        </div>
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2">
                                                                    <input type="radio" class="status-radio"
                                                                        id="edit-active-{{ $setting->id }}" name="status"
                                                                        value="1"
                                                                        {{ $setting->status == 1 ? 'checked' : '' }}>
                                                                    <label
                                                                        for="edit-active-{{ $setting->id }}">Active</label>
                                                                </div>
                                                                <div>
                                                                    <input type="radio" class="status-radio"
                                                                        id="edit-inactive-{{ $setting->id }}"
                                                                        name="status" value="0"
                                                                        {{ $setting->status == 0 ? 'checked' : '' }}>
                                                                    <label
                                                                        for="edit-inactive-{{ $setting->id }}">Inactive</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="delete_Document{{ $setting->id }}" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-sm">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <form action="{{ route('document-settings.destroy', $setting->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        {{ $documentsettings->withQueryString()->links() }}
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="add_Document" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="{{ route('document-settings.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
