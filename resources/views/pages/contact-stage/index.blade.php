    ...
    <div class="page-wrapper">
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                <div>
                    <h4 class="mb-1">Contact Stages<span class="badge badge-soft-primary ms-2">{{ count($stages) }}</span></h4>
                            ...
                            <tbody>
                             @php $serial = 1; @endphp
                                @foreach ($stages as $stage)
                                    ...
                                    <!-- Edit Source Modal -->
                                    <div class="modal fade" id="edit_source{{ $stage->id }}" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('contact-stage.update', $stage->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name"
                                                                value="{{ $stage->name }}" class="form-control" required>
                                                        </div>
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2">
                                                                    <input type="radio" class="status-radio"
                                                                        id="edit-active-{{ $stage->id }}"
                                                                        name="status" value="1"
                                                                        {{ $stage->status == 1 ? 'checked' : '' }}>
                                                                    <label
                                                                        for="edit-active-{{ $stage->id }}">Active</label>
                                                                </div>
                                                                <div>
                                                                    <input type="radio" class="status-radio"
                                                                        id="edit-inactive-{{ $stage->id }}"
                                                                        name="status" value="0"
                                                                        {{ $stage->status == 0 ? 'checked' : '' }}>
                                                                    <label
                                                                        for="edit-inactive-{{ $stage->id }}">Inactive</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="delete_source" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-sm">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <form action="{{ route('contact-stage.destroy', $stage->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <div class="modal fade" id="add_source" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('contact-stage.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
