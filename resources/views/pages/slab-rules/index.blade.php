    ...
    <div class="page-wrapper">
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                <div>
                    <h4 class="mb-1">Slab Rules <span class="badge badge-soft-primary ms-2">{{ count($slabRules) }}</span>
                    </h4>
                ...
                <div class="gap-2 d-flex align-items-center flex-wrap">
                    ...
                    <button class="btn btn-icon btn-outline-light shadow" onclick="location.reload()"><i
                            class="ti ti-refresh"></i></button>
                    <button class="btn btn-icon btn-outline-light shadow" id="collapse-header"><i
                            class="ti ti-transition-top"></i></button>
                </div>
            </div>
            ...
            <div class="card border-0 rounded-0">
                <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                    {{-- 🔍 WORKING SEARCH FORM --}}
                    <form method="GET" action="{{ route('slab-rules.index') }}" id="slabFilterForm"
                        ...
                        <div class="input-icon input-icon-start position-relative flex-grow-1" style="max-width: 350px;">
                            ...
                            <input type="text" name="search" class="form-control"
                                placeholder="Search consultant, college, course..." value="{{ request('search') }}">
                        </div>
                        ...
                        <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                            ...
                            <div class="dropdown">
                                <select name="sort" class="select form-select-sm" style="width: auto;">
                                    <option value="threshold_asc"
                                        {{ request('sort', 'threshold_asc') == 'threshold_asc' ? 'selected' : '' }}>Lowest
                                        Threshold</option>
                                    <option value="threshold_desc"
                                        {{ request('sort') == 'threshold_desc' ? 'selected' : '' }}>Highest Threshold
                                    </option>
                            ...
                            <input type="text" name="start_date" class="form-control form-control-sm"
                                placeholder="Start Date" value="{{ request('start_date') }}" data-provider="flatpickr"
                                data-date-format="Y-m-d" style="width: 130px;">
                            <input type="text" name="end_date" class="form-control form-control-sm"
                                placeholder="End Date" value="{{ request('end_date') }}" data-provider="flatpickr"
                                data-date-format="Y-m-d" style="width: 130px;">

                            <!-- 🎛️ FILTER DROPDOWN -->
                            <div class="dropdown">
                                <button type="button" class="btn btn-outline-light shadow px-2 dropdown-toggle"
                                    data-bs-toggle="dropdown" data-bs-auto-close="outside">
                                    <i class="ti ti-filter me-2"></i>Filters
                                </button>
                                <div class="dropdown-menu dropdown-menu-lg p-0" style="min-width: 300px;">
                                    <div
                                        class="filter-header d-flex align-items-center justify-content-between border-bottom p-3">
                                        ...
                                        <div class="accordion" id="slabFilterAccordion">
                                            ...
                                            <div class="filter-set-content mb-3">
                                                <div class="filter-set-content-head">
                                                    <a href="#" class="collapsed d-block text-decoration-none"
                                                        data-bs-toggle="collapse" data-bs-target="#filterThreshold"
                                                        aria-expanded="false"><i class="ti ti-hash me-1"></i>Threshold</a>
                                                </div>
                                                <div class="filter-set-contents accordion-collapse collapse"
                                                    id="filterThreshold" data-bs-parent="#slabFilterAccordion">
                                                    <div class="bg-light rounded border p-2 mt-2">
                                                        <label class="d-flex align-items-center mb-1"><input
                                                                class="form-check-input m-0 me-2" type="checkbox"
                                                                name="threshold[]" value="5"
                                                                {{ in_array('5', request('threshold', [])) ? 'checked' : '' }}>
                                                            5 Admissions</label>
                                                        <label class="d-flex align-items-center mb-1"><input
                                                                class="form-check-input m-0 me-2" type="checkbox"
                                                                name="threshold[]" value="10"
                                                                {{ in_array('10', request('threshold', [])) ? 'checked' : '' }}>
                                                            10 Admissions</label>
                                                        <label class="d-flex align-items-center"><input
                                                                class="form-check-input m-0 me-2" type="checkbox"
                                                                name="threshold[]" value="15+"
                                                                {{ in_array('15+', request('threshold', [])) ? 'checked' : '' }}>
                                                            15+ Admissions</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="filter-set-content mb-3">
                                                <div class="filter-set-content-head">
                                                    <a href="#" class="collapsed d-block text-decoration-none"
                                                        data-bs-toggle="collapse" data-bs-target="#filterStatus"
                                                        aria-expanded="false"><i
                                                            class="ti ti-toggle-left me-1"></i>Status</a>
                                                </div>
                                                <div class="filter-set-contents accordion-collapse collapse"
                                                    id="filterStatus" data-bs-parent="#slabFilterAccordion">
                                                    <div class="bg-light rounded border p-2 mt-2">
                                                        <label class="d-flex align-items-center mb-1"><input
                            ...
                            <button type="button" onclick="resetFilters()"
                                class="btn btn-outline-light flex-fill">Reset</button>

                            <button type="submit" class="btn btn-primary"><i
                                    class="ti ti-search me-1"></i>Apply</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvas_add_slab">
                             ...
                             @php $serial = 1; @endphp
                                @forelse ($slabRules as $slab)
                                    <tr>
                                        ...
                                        <td><span class="badge bg-warning text-dark">{{ $slab->threshold }}
                                                Admissions</span></td>
                                        <td>{{ number_format($slab->bonus_value, 2) }}{{ $slab->bonus_type == 'fixed_amount' ? ' ' . $slab->currency : '%' }}
                                        </td>
                                        ...
                                        <td><span
                                                class="badge bg-{{ $slab->status == 'active' ? 'success' : 'secondary' }}">{{ ucfirst($slab->status) }}</span>
                                        </td>
                                        <td>
                                            <div class="dropdown table-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                        ...
                                                        data-bs-target="#offcanvas_edit_slab{{ $slab->id }}">
                                                        <i class="ti ti-edit text-blue me-1"></i> Edit
                                                    </a>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                        data-bs-target="#delete_slab{{ $slab->id }}">
                                    ...
                                    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1"
                                        id="offcanvas_edit_slab{{ $slab->id }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="consultant_id" class="form-select select">
                                                            ...
                                                            @foreach ($consultants as $c)
                                                                <option value="{{ $c->id }}"
                                                                    {{ $slab->consultant_id == $c->id ? 'selected' : '' }}>
                                                                    {{ $c->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="college_id" class="form-select select">
                                                            ...
                                                            @foreach ($colleges as $col)
                                                                <option value="{{ $col->id }}"
                                                                    {{ $slab->college_id == $col->id ? 'selected' : '' }}>
                                                                    {{ $col->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="course_name" class="form-select select">
                                                            ...
                                                            @foreach ($courses as $crs)
                                                                <option value="{{ $crs }}"
                                                                    {{ $slab->course_name == $crs ? 'selected' : '' }}>
                                                                    {{ $crs }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Trigger Threshold <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" name="threshold" class="form-control"
                                                            value="{{ $slab->threshold }}" min="1" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Bonus Type <span
                                                                class="text-danger">*</span></label>
                                                        <select name="bonus_type" class="form-select select" required>
                                                            <option value="fixed_amount"
                                                                {{ $slab->bonus_type == 'fixed_amount' ? 'selected' : '' }}>
                                                                Fixed Amount</option>
                                                            <option value="percentage_of_commission"
                                                                {{ $slab->bonus_type == 'percentage_of_commission' ? 'selected' : '' }}>
                                                                % of Commission</option>
                                                            <option value="percentage_of_fee"
                                                                {{ $slab->bonus_type == 'percentage_of_fee' ? 'selected' : '' }}>
                                                                % of Course Fee</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Bonus Value <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" step="0.01" name="bonus_value"
                                                            class="form-control" value="{{ $slab->bonus_value }}"
                                                            required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Scope</label>
                                                        <select name="scope" class="form-select select" required>
                                                            <option value="per_college"
                                                                {{ $slab->scope == 'per_college' ? 'selected' : '' }}>Per
                                                                College</option>
                                                            <option value="global"
                                                                {{ $slab->scope == 'global' ? 'selected' : '' }}>Global
                                                                (All Colleges)</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-check form-switch mt-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="retroactive" value="1"
                                                                {{ $slab->retroactive ? 'checked' : '' }}>
                                                            <label class="form-check-label">Apply bonus retroactively when
                                                                threshold is met</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="currency" class="form-select select">
                                                            <option value="INR"
                                                                {{ $slab->currency == 'INR' ? 'selected' : '' }}>INR (₹)
                                                            </option>
                                                            <option value="USD"
                                                                {{ $slab->currency == 'USD' ? 'selected' : '' }}>USD ($)
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="status" class="form-select select">
                                                            <option value="active"
                                                                {{ $slab->status == 'active' ? 'selected' : '' }}>Active
                                                            </option>
                                                            <option value="inactive"
                                                                {{ $slab->status == 'inactive' ? 'selected' : '' }}>
                                                                Inactive</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-12">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
                                            <div class="modal-content rounded-0">
                                                <div class="modal-body p-4 text-center position-relative">
                                                    <form action="{{ route('slab-rules.destroy', $slab) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
                                                        ...
                                                        <p class="mb-3">Are you sure you want to remove this Slab Rule?
                                                        </p>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center py-4 text-muted">No slab rules configured
                                            yet.</td>
                                    </tr>
                                @endforelse
                            </tbody>
            ...
            <form action="{{ route('slab-rules.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="threshold" class="form-control" min="1" required
