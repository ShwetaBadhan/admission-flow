...
@section('content')
  <!-- ========================
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input class="input-tags form-control border-0 h-100" data-choices="" data-choices-limit="infinite" data-choices-removeitem="" type="text" value="Small Business, Corporate Companies, Urban Apartment">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                        ...
                        <div class="col-md-5">
                           <div class="card shadow">
                               <div class="card-body">
                                   <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="avatar rounded bg-success fs-24 flex-shrink-0"><i class="ti ti-file-spreadsheet"></i></span>
                                            <div>
                                                <h6 class="mb-1 fs-14 fw-medium">Project Specs.xls</h6>
                                                <p class="mb-0">365 KB</p>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="btn btn-icon btn-xs rounded-circle btn-outline-light flex-shrink-0"><i class="ti ti-download"></i></a>
                                    </div>
                               </div>
                           </div>
                        </div>
                        <div class="col-md-5">
                           <div class="card bg-light">
                               <div class="card-body">
                                   <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="avatar rounded bg-success fs-24 flex-shrink-0"><img src="assets/img/blogs/blog-1.jpg" alt="img"></span>
                                            <div>
    ...
    <!-- delete modal -->
    <div class="modal fade" id="delete_campaign">
        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    ...
                    <p class="mb-3">Are you sure you want to remove campaign you selected.</p>
