            ...
            <div class="card border-0 rounded-0">
                ...
                <div class="card-body">
                                            ...
                                            <div class="filter-set-content">
                                                <div class="filter-set-content-head">
                                                    <a href="#" class="collapsed" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseThree">Name</a>
                                                </div>
                                            ...
                                            <div class="filter-set-content">
                                                <div class="filter-set-content-head">
                                                    <a href="#" class="collapsed" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="date">Start Date</a>
                                                </div>
                                                <div class="filter-set-contents accordion-collapse collapse"
                                            ...
                                            <div class="filter-set-content">
                                                <div class="filter-set-content-head">
                                                    <a href="#" class="collapsed" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="date2">End Date</a>
                                                </div>
                                                <div class="filter-set-contents accordion-collapse collapse"
                    ...
                    <div class="table-responsive table-nowrap custom-table">
                        <table class="table table-nowrap" id="Commission Rules-list">
