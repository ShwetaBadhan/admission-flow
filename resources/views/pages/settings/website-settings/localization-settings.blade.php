    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
            ...
            <div class="gap-2 d-flex align-items-center flex-wrap">
                <a href="javascript:void(0);" class="btn btn-icon btn-outline-light shadow" title="Refresh" data-bs-toggle="tooltip">
                    <i class="ti ti-refresh"></i>
                </a>
                <a href="javascript:void(0);" class="btn btn-icon btn-outline-light shadow" title="Collapse" id="collapse-header" data-bs-toggle="tooltip">
                        ...
                        <form action="{{ route('localization-settings.update') }}" method="POST">
                            ...
                            <div class="border-bottom mb-3">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('default_language') is-invalid @enderror" name="default_language" required>
                                            <option value="">Select Language</option>
                                            @foreach(['English', 'German', 'Arabic', 'French', 'Spanish', 'Italian'] as $lang)
                                                <option value="{{ $lang }}" {{ old('default_language', $settings->default_language ?? '') == $lang ? 'selected' : '' }}>{{ $lang }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row align-items-center mb-3">
                                    <div class="col-md-8">
                                        ...
                                        <p class="fs-13 mb-0">Display language selector on all pages</p>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="language_switcher" value="1" {{ old('language_switcher', $settings->language_switcher ?? false) ? 'checked' : '' }}>
                                        </div>
                                        @error('language_switcher') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('time_zone') is-invalid @enderror" name="time_zone" required>
                                            ...
                                            @foreach($timezones as $value => $label)
                                                <option value="{{ $value }}" {{ old('time_zone', $settings->time_zone ?? '') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                        @error('time_zone') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('date_format') is-invalid @enderror" name="date_format" required>
                                            @php
                                                $dateFormats = [
                                                    'd M Y' => '18 Mar 2025',
                                                    'M d, Y' => 'Mar 18, 2025',
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('time_format') is-invalid @enderror" name="time_format" required>
                                            <option value="12" {{ old('time_format', $settings->time_format ?? '') == '12' ? 'selected' : '' }}>12 Hours (AM/PM)</option>
                                            <option value="24" {{ old('time_format', $settings->time_format ?? '') == '24' ? 'selected' : '' }}>24 Hours</option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('financial_year') is-invalid @enderror" name="financial_year">
                                            @for($year = date('Y'); $year >= date('Y') - 10; $year--)
                                                <option value="{{ $year }}" {{ old('financial_year', $settings->financial_year ?? date('Y')) == $year ? 'selected' : '' }}>{{ $year }}-{{ $year + 1 }}</option>
                                            @endfor
                                        </select>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('start_month') is-invalid @enderror" name="start_month">
                                            @php
                                                $months = ['January','February','March','April','May','June','July','August','September','October','November','December'];
                                            @endphp
                                            @foreach($months as $index => $month)
                                                <option value="{{ $index + 1 }}" {{ old('start_month', $settings->start_month ?? 1) == $index + 1 ? 'selected' : '' }}>{{ $month }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="border-bottom mb-3">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('currency') is-invalid @enderror" name="currency" id="currencySelect" required>
                                            @php
                                                $currencies = [
                                                    'USD' => 'US Dollar ($)',
                                                    'EUR' => 'Euro (€)',
                                            ...
                                            @foreach($currencies as $code => $label)
                                                <option value="{{ $code }}" {{ old('currency', $settings->currency ?? '') == $code ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('currency_symbol') is-invalid @enderror" name="currency_symbol" id="currencySymbol" required>
                                            @php
                                                $symbols = ['$', '€', '£', '₹', 'د.إ', '¥', '₽', '₩'];
                                            @endphp
                                            @foreach($symbols as $sym)
                                                <option value="{{ $sym }}" {{ old('currency_symbol', $settings->currency_symbol ?? '$') == $sym ? 'selected' : '' }}>{{ $sym }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('currency_position') is-invalid @enderror" name="currency_position" id="currencyPosition" required>
                                            @php
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('decimal_separator') is-invalid @enderror" name="decimal_separator" required>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('thousand_separator') is-invalid @enderror" name="thousand_separator" required>
                                            <option value="," {{ old('thousand_separator', $settings->thousand_separator ?? ',') == ',' ? 'selected' : '' }}>, (Comma)</option>
                                            <option value="." {{ old('thousand_separator', $settings->thousand_separator ?? ',') == '.' ? 'selected' : '' }}>. (Period)</option>
                                            <option value=" " {{ old('thousand_separator', $settings->thousand_separator ?? ',') == ' ' ? 'selected' : '' }}> (Space)</option>
                                            <option value="" {{ old('thousand_separator', $settings->thousand_separator ?? ',') == '' ? 'selected' : '' }}>None</option>
                                        </select>
                            ...
                            <div class="border-bottom mb-3">
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select class="select @error('country_restriction') is-invalid @enderror" name="country_restriction">
                                            <option value="allow_all" {{ old('country_restriction', $settings->country_restriction ?? 'allow_all') == 'allow_all' ? 'selected' : '' }}>Allow All Countries</option>
                                            <option value="deny_all" {{ old('country_restriction', $settings->country_restriction ?? 'allow_all') == 'deny_all' ? 'selected' : '' }}>Deny All Countries</option>
                                            <option value="allow_selected" {{ old('country_restriction', $settings->country_restriction ?? 'allow_all') == 'allow_selected' ? 'selected' : '' }}>Allow Selected Only</option>
                                            <option value="deny_selected" {{ old('country_restriction', $settings->country_restriction ?? 'allow_all') == 'deny_selected' ? 'selected' : '' }}>Deny Selected Only</option>
                                        </select>
                                        @error('country_restriction') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="border-bottom mb-3 border-0">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control @error('allowed_files') is-invalid @enderror" name="allowed_files" 
                                               value="{{ old('allowed_files', $settings->allowed_files ?? 'jpg, png, gif, pdf, doc, docx') }}" 
                                               placeholder="e.g., jpg, png, pdf">
                                        @error('allowed_files') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" class="form-control @error('max_file_size') is-invalid @enderror" name="max_file_size" 
                                               value="{{ old('max_file_size', $settings->max_file_size ?? 5) }}" min="1" max="100" placeholder="5">
                                        @error('max_file_size') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currencySymbol && currencyPosition) {
        function updatePositionOptions() {
            ...
            const positions = [
                { value: symbol + '100', label: symbol + '100 (Prefix, no space)' },
                { value: '100' + symbol, label: '100' + symbol + ' (Suffix, no space)' },
                { value: symbol + ' 100', label: symbol + ' 100 (Prefix, with space)' },
                { value: '100 ' + symbol, label: '100 ' + symbol + ' (Suffix, with space)' },
            ];
