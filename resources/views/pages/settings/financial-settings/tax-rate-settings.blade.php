...
@section('content')
 ...
 <!-- ========================
		...
		<!-- Add Tax Group -->
		<div class="modal fade" id="add_tax_group" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
					...
					<form action="tax-rates.html">
						<div class="modal-body">
							...
							<div class="mb-0">
								...
								<p class="mb-0 fs-12 mt-1">Enter value separated by comma</p>
							</div>
						</div>
						<div class="modal-footer">
							<div class="d-flex align-items-center justify-content-end m-0">
		...
		<!-- Edit Tax Group -->
		<div class="modal fade" id="edit_tax_group" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
					...
					<form action="tax-rates.html">
						<div class="modal-body">
							...
							<div class="mb-0">
								<label class="form-label">Sub Taxes <span class="text-danger">*</span></label>
								<input class="input-tags form-control border-0 h-100" data-choices data-choices-limit="infinite" data-choices-removeItem type="text" value="CGST, SGST">
								<p class="mb-0 fs-12 mt-1">Enter value separated by comma</p>
							</div>
						</div>
						<div class="modal-footer">
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
                <div class="modal-content rounded-0">
                    <div class="modal-body p-4 text-center position-relative">
                        ...
                        <h5 class="mb-1">Delete Confirmation</h5>
                        <p class="mb-3">Are you sure you want to remove rate group you selected..</p>
                        <div class="d-flex justify-content-center">
