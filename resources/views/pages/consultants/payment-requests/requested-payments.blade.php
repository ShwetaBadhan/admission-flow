                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('payment-requests.index') }}">Payment Requests</a>
                            </li>
                ...
                <div class="card-body">
                    <form action="{{ route('payment-requests.requested') }}" method="GET" class="row g-3">
                        ...
                        <div class="col-md-2 d-flex align-items-end gap-2">
                            <button type="submit" class="btn btn-primary flex-fill"><i class="ti ti-filter me-1"></i>
                                Filter</button>
                            <a href="{{ route('payment-requests.requested') }}" class="btn btn-outline-secondary"><i
                    ...
                    <div class="table-responsive">
                        <table class="table table-nowrap table-hover align-middle">
                            ...
                            <tbody>
                                @forelse($paymentRequests ?? [] as $request)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span
                                                class="badge bg-{{ $colors[$request->status] ?? 'secondary' }}">{{ ucfirst($request->status) }}</span>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center py-5 text-muted">No payment requests found.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6 text-end"><strong>Status:</strong> <span class="badge"
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tfoot class="table-light fw-bold">
                                <tr>
                                    ...
                                    <td class="text-end text-primary" id="paymentsTotal">₹0.00</td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content rounded-0">
                <form id="payForm" method="POST">
                    ...
                    <div class="modal-body">
                        <p class="text-muted mb-3">Request #<span id="payModalNumber"></span> - ₹<span
                                id="payModalAmount"></span></p>
                        <div class="mb-3">
                            <label class="form-label">Payment Reference *</label>
                            <input type="text" name="payment_reference" class="form-control"
                                placeholder="TXN-2024-001" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success btn-sm"><i class="ti ti-check me-1"></i>
                            Confirm</button>
                    </div>
                </form>
            </div>
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.view-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (data.status === 'rejected' && data.notes && data.notes.includes(
                            '❌ Rejected:')) {
                        rejectBox.style.display = 'block';
                        document.getElementById('rejectionText').textContent = data.notes.split(
                            '❌ Rejected:')[1]?.trim() || '';
                    } else {
        ...
        data-id="${data.id}">  <!-- ✅ Add this data-id -->
    <i class="ti ti-x me-1"></i> Reject
            ...
            document.getElementById('viewModal')?.addEventListener('click', function(e) {
                ...
                if (data.status === 'rejected' && data.notes && data.notes.includes('❌ Rejected:')) {
                    rejectBox.style.display = 'block';
                    document.getElementById('rejectionText').textContent = data.notes.split('❌ Rejected:')[
                        1]?.trim() || '';
                } else {
                    rejectBox.style.display = 'none';
                }
            ...
            document.getElementById('rejectModal')?.addEventListener('show.bs.modal', function(event) {
                ...
                // Set the form action to the correct reject route
                document.getElementById('rejectForm').action = `/payment-requests/${id}/reject`;
            });
