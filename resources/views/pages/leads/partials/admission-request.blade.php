<div class="card mt-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#new_admission_request">
                                ...
                                <td>
                                    ...
                                    <div class="dropdown table-action">
                                        <span
                                            ...
                                            data-bs-placement="top" {{-- ✅ Add this line --}} data-bs-toggle="dropdown"
            ...
            <form action="{{ route('leads.admission-request', $lead) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        @if (Auth::user()->hasRole('consultant') && $colleges->isEmpty())
                            <small class="text-danger">No colleges assigned to you. Contact admin.</small>
                        @endif
                    </div>
