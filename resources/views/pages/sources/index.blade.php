                            ...
                            <tbody>
                                @foreach ($sources as $source)
                                    <tr>
                                        ...
                                        <td>{{ $source->created_at->format('d M Y, h:i A') }}</td>
                                        <td>
                                            @if ($source->status == 1)
                                            ...
                                            <div class="dropdown table-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item edit-btn" href="#" data-bs-toggle="modal"
                                                        data-bs-target="#edit_source{{ $source->id }}">
                                    ...
                                    <!-- Edit Source Modal -->
                                    <div class="modal fade" id="edit_source{{ $source->id }}" role="dialog">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name"
                                                                value="{{ $source->name }}" class="form-control" required>
                                                        </div>
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2">
                                                                    ...
                                                                    <label
                                                                        for="edit-active-{{ $source->id }}">Active</label>
                                                                </div>
                                                                <div>
                                                                    <input type="radio" class="status-radio"
                                                                        id="edit-inactive-{{ $source->id }}"
                                                                        name="status" value="0"
                                                                        {{ $source->status == 0 ? 'checked' : '' }}>
                                                                    <label
                                                                        for="edit-inactive-{{ $source->id }}">Inactive</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="delete_source" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-sm">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <form action="{{ route('sources.destroy', $source->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
