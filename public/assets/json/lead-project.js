$(document).ready(function () { 
    if($('#lead-project').length > 0) {
		...
		"columns": [
			...
			{ "render": function ( data, type, row ){
				if(row['status'] == "0")
					 { var class_name = "bg-success";var status_name ="Closed" } if(row['status'] == "1") { var class_name = "bg-success";var status_name ="Closed" } else { var class_name = "bg-warning";var status_name ="Contacted"}
